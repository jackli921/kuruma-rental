  ...
  webServer: [
    ...
    },
    {
      ...
      env: {
        ...
        // settings (#903) and reviews (#1083-1086). Enable them here so e2e
        // covers the FULL product; the beta Pages build (deploy.yml) sets none
        // of these, so the demo still hides them. Fail-safe-OFF default lives
        // in vite/config/features.ts.
