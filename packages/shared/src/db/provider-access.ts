...
// PENDING -> ACCEPTED, or PENDING -> REVOKED (owner self-service revoke, #904).
// Both are terminal. Expired-ness stays COMPUTED from expiresAt, never stored
// (YAGNI; the EXPIRED sweep is still a follow-up, §13).
