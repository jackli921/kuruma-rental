 ...
 * noreferrer">` — never the i18n `Link`. Pure presentational (strings in, JSX
 * out); the page resolves i18n and ownership. A `null` url hides the card
 * entirely rather than rendering a dead link (proposal §8.1: tourist UX).
 */
